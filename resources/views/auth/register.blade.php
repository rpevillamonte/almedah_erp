                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="tel" class="form-control @error('contact_number') is-invalid @enderror" value="{{ old('contact_number') }}" id="contact_number" name='contact_number' placeholder="####-###-####" required autocomplete="contact_number">
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="profile_picture" value="default">
