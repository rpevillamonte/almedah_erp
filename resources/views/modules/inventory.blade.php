                ...
                <form id="material-form" method="post" enctype="multipart/form-data" action="/create-material">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="">Material Categories</label>
                                <select class="form-control" id="material_category1" onchange="openCategory(value)"
                                    required>
                                    <option value="" selected disabled hidden>
                                        Select an Option
                                    </option>
                    ...
                    <div class="form-group p-2">
                        ...
                        <input class="form-control" type="file" name="material_image" onchange="readURL1(this);"
                            required>
                    </div>
